...
const DiseaseChat = ({ route, navigation }) => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/disease-chat/send-message`,
        {
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: "#F8FAFC" }}>
        ...
        >
          <View style={{ flex: 1, backgroundColor: "#F8FAFC" }}>
            ...
            {/* Messages FlatList - NO ScrollView wrapper needed */}
            {messages.length === 0 ? (
              <View
                style={{
                  flex: 1,
            ...
            >
              {chatInfo?.can_continue ? (
                ...
                >
                  ...
                  >
                    You have reached the maximum number of messages (3) for this disease. Thank you for chatting with Kaku! You can start a new scan to chat about a different disease.
                  </Text>
                </View>
              )}
            </View>
